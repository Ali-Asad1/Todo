      ...
      <div className="flex flex-col-reverse mt-10">
        <textarea
          className={classNames(
            "peer w-full h-24 mt-2 px-3 pt-3 bg-slate-4 rounded-md border border-slate-6 text-sm focus:border-teal-8 focus:outline-none transition-colors placeholder:font-roboto placeholder:text-sm resize-none",
